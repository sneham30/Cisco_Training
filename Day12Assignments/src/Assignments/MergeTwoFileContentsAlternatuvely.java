...
public class MergeTwoFileContentsAlternatuvely {
	...
	/**
	 * Method to Merge 2 files such that merge file has alternative lines of two
	 * files.
	 * Uses scanner Object to read contents from file line by line
	 *
	 *
	 * @param file1
	...
	public static void main(String[] args) {
		...
		File mergeFile = new File("mergeFileLine.txt");

		String file1Contents[] = { "hi", "hello", "over!!" };
		String file2Contents[] = { "sneha", "shree", "finished!!" };
